 ...
 * =============================================================================
 *
 * Entry point for the extrude engine. Resolves text-to-SVG via Google Fonts,
...
import { textToSvg, useFont } from "./use-font";
...
export function SVG3D(props: SVG3DProps) {
  ...
  const loadingEl = <div style={containerStyle} className={className} />;
    ...
    <div style={containerStyle} className={className}>
      <Suspense fallback={loadingEl}>
        <SVG3DScene
          ...
          introFrom={introFrom}
          introTo={{
            ...defaultProps.introTo,
            ...introToProp,
            zoom: introToProp?.zoom ?? zoom,
          }}
...
export type { MaterialPreset, SVG3DProps } from "./types";

// Scene internals
export { ExtrudedSVG, SVG3DScene, useExtrudedGeometry } from "./scene";
export type {
  ExtrudedGeometryResult, ExtrudedSVGProps, SVG3DSceneProps
} from "./scene";
...
// Font utilities
export { textToSvg, useFont } from "./use-font";
