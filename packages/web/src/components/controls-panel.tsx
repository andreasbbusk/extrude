...
import type { AnimationType } from "extrude";
...
function Section({
  ...
  return (
    <div className="border-b border-white/6">
      <button
        onClick={toggle}
        className={`flex w-full items-center gap-2 py-3 px-4 cursor-pointer transition-colors ${open ? "bg-white/3" : "hover:bg-white/3"}`}
      >
...
export function ControlsPanel({
  ...
  return (
    <div className="w-72 max-md:w-full rounded-xl bg-card/70 backdrop-blur-xl border border-white/6 shadow-[0_8px_32px_oklch(0_0_0/0.4)] h-full flex flex-col overflow-hidden">
      {/* Header -- fixed at top */}
        ...
        >
          <div className="space-y-2">
            <div className="relative flex items-center gap-2 h-8 rounded-md border border-input bg-background/30 px-2 cursor-pointer overflow-hidden">
              ...
              />
              <div
                className="h-4 w-4 rounded-sm border border-white/10 shrink-0"
        ...
        >
          <div className="space-y-2">
            <select
              ...
              className="w-full h-8 rounded-md border border-input bg-background/30 px-3 pr-8 text-xs ring-offset-background focus:outline-none focus:ring-1 focus:ring-ring appearance-none bg-no-repeat bg-position-[right_8px_center] bg-size-[12px]"
              style={{
        ...
        >
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <span className="text-xs text-muted-foreground font-mono">
                {lightSettings.keyX.toFixed(1)}
              </span>
            </div>
            <Slider
              value={[lightSettings.keyX]}
              onValueChange={([v]) =>
                onLightSettingsChange({ ...lightSettings, keyX: v })
              }
              min={-10}
              max={10}
              step={0.5}
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <span className="text-xs text-muted-foreground font-mono">
                {lightSettings.keyY.toFixed(1)}
              </span>
            </div>
            <Slider
              value={[lightSettings.keyY]}
              onValueChange={([v]) =>
                onLightSettingsChange({ ...lightSettings, keyY: v })
              }
              min={-10}
              max={10}
              step={0.5}
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <span className="text-xs text-muted-foreground font-mono">
                {lightSettings.keyZ.toFixed(1)}
              </span>
            </div>
            <Slider
              value={[lightSettings.keyZ]}
              onValueChange={([v]) =>
                onLightSettingsChange({ ...lightSettings, keyZ: v })
              }
              min={-10}
              max={10}
              step={0.5}
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <span className="text-xs text-muted-foreground font-mono">
                {lightSettings.keyIntensity.toFixed(1)}
              </span>
            </div>
            <Slider
              value={[lightSettings.keyIntensity]}
              onValueChange={([v]) =>
                onLightSettingsChange({ ...lightSettings, keyIntensity: v })
              }
              min={0}
              max={5}
              step={0.1}
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <span className="text-xs text-muted-foreground font-mono">
                {lightSettings.ambientIntensity.toFixed(2)}
              </span>
            </div>
            <Slider
              value={[lightSettings.ambientIntensity]}
              onValueChange={([v]) =>
                onLightSettingsChange({ ...lightSettings, ambientIntensity: v })
              }
              min={0}
              max={2}
              step={0.05}
