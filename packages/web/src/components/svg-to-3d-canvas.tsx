 ...
 * =============================================================================
 *
 * Web editor wrapper around the extrude engine's <SVG3D> component. Injects
...
import type { AnimationType, MaterialSettings } from "extrude";
import { SVG3D } from "extrude";
...
function Download3DCapture({
  ...
  useEffect(() => {
    ...
    register3DExport((format, filename = "extrude") => {
